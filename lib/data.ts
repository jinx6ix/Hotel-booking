...
// ALL HOTELS - including original ones and new accessible ones
export const hotels: Hotel[] = [
  ...
  // CROWNE PLAZA NAIROBI (ACCESSIBLE)
  {
    id: "nairobi-002",
    ...
    description: "Premium 5-star hotel in Upper Hill with contemporary African decor and exceptional service. Features wheelchair accessible rooms with roll-in showers and grab bars.",
    amenities: ["WiFi", "Pool", "Fitness Center", "Multiple Restaurants", "Bar", "Spa", "Concierge", "Parking", "Accessible Facilities"],
  ...
  // KIBO COLLECTION (ACCESSIBLE)
  {
    ...
    email: "reservations@kibocollection.com",
    accessible: true,
    accessibleRoomCount: 3,
  ...
  // TAMARIND TREE NAIROBI (ACCESSIBLE)
  {
    ...
    email: "info@tamarindtreehotel.com",
    accessible: true,
    accessibleRoomCount: 3,
  ...
  // SAROVA IMPERIAL KISUMU (ACCESSIBLE)
  {
    ...
    phone: "+254 57 202 4000",
    email: "imperial@sarovahotels.com",
    accessible: true,
    accessibleRoomCount: 3,
